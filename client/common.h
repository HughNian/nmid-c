//
// Created by hughnian on 2020/5/29.
//

#ifndef LIBNMID_CLIENT_COMMON_H
#define LIBNMID_CLIENT_COMMON_H
...
typedef void (*RespHandler)(Response *Res);
